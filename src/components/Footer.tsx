...
export default function Footer() {
  return (
    <motion.footer 
      className="bg-charcoal text-sand py-16"
      initial={{ opacity: 0 }}
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h3 className="text-3xl font-heading font-bold text-copper mb-3">ARAMBA</h3>
            <p className="text-sand/70 font-light text-sm">
          ...
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <ul className="space-y-2 text-sand/70 font-light text-sm">
              ...
              <li><Link to="/certifications" className="hover:text-copper transition-colors">Certifications</Link></li>
            </ul>
          </motion.div>

          {/* Support */}
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h4 className="font-heading font-bold mb-4 text-sm uppercase tracking-wider">Support</h4>
            <ul className="space-y-2 text-sand/70 font-light text-sm">
              <li><a href="#" className="hover:text-copper transition-colors">FAQ</a></li>
              <li><a href="#" className="hover:text-copper transition-colors">Shipping Info</a></li>
              <li><a href="#" className="hover:text-copper transition-colors">Returns</a></li>
              <li><a href="#" className="hover:text-copper transition-colors">Privacy Policy</a></li>
            </ul>
          </motion.div>

          {/* Social */}
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h4 className="font-heading font-bold mb-4 text-sm uppercase tracking-wider">Follow Us</h4>
            <div className="flex gap-4">
              <motion.a 
                href="#" 
                className="text-sand/70 hover:text-copper transition-colors"
        ...
        <motion.div 
          className="border-t-2 border-sand/20 pt-8 text-center text-sand/60 font-light text-sm"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
