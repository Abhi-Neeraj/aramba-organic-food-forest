      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <p className="text-gray-400 font-paragraph text-sm">
          ...
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <ul className="space-y-2 text-gray-400 font-paragraph text-sm">
          ...
          {/* Social */}
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h4 className="font-heading font-semibold mb-4 text-sm">Follow Us</h4>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400 font-paragraph text-sm">
